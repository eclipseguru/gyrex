...
import org.eclipse.gyrex.boot.tests.AllBootTests;
...
@RunWith(Suite.class)
@SuiteClasses({ AllPreferencesTests.class, AllPersistenceTests.class, AllContextTests.class, AllJobTests.class, AllBootTests.class })
