...
/**
 * Metrics for {@link SolrSearchService}.
 */
public class SolrSearchServiceMetrics extends MetricSet {
	 ...
	 * @param metrics
	 */
	protected SolrSearchServiceMetrics(final String id, final String description) {
