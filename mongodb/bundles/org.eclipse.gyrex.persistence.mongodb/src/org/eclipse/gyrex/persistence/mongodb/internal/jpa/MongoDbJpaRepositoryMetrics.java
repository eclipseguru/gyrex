 ...
 *
 */
public class MongoDbJpaRepositoryMetrics extends MetricSet {
	...
	public MongoDbJpaRepositoryMetrics(final String id, final String repositoryId, final RepositoryProvider repositoryProvider, final String initialStatus, final String initialStatusReason) {
